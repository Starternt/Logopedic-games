            ...
            <div class="row">
                ...
                <div class="breadcrumbs">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Управление достижениями</li>
                    </ol>
                </div>
                <a href="/admin/awards/add" class="btn btn-success back"><i class="fa fa-plus"></i> Добавить
                    элемент</a>
                ...
                <table class="table-bordered table-striped table">
                    ...
                    @foreach($data as $item)
                        <tr>
                            ...
                            <td><a href="/admin/awards/edit/{{$item->id}}" title="Редактировать"><i
                                            class="fa fa-pencil-square-o"></i></a></td>
                            <td><a href="/admin/awards/destroy/{{$item->id}}" title="Удалить"><i
